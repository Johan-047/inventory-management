    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
           ...
           <form action="database_db.php" method="POST" id="editForm<?= $out['id']; ?>">
				...
				<div class="form-group">
					<label for="edit_instrument_type<?= $out['id']; ?>">User Name</label>
					<input type="text" class="form-control" name="user_name" id="edit_user_name<?= $out['id']; ?>" value="<?= $out['user_name']; ?>">
				</div>
				<div class="form-group">
					<label for="edit_status<?= $out['id']; ?>">Password</label>
					<input type="text" class="form-control" id="edit_password<?= $out['id']; ?>" name="password" value="<?= $out['password']; ?>">
				</div>
			</form>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary" form="editForm<?= $out['id']; ?>" name="change_user_details">Save Changes</button>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    $('.delete-btn').click(function() {
        ...
        $.ajax({
            ...
            data: {
                id: itemId,
                delete_user: true // Add a flag to identify the delete action in your PHP script
            },
